...
gateway = braintree.BraintreeGateway(
    braintree.Configuration(
        ...
        merchant_id="yhykx9zj4ftky449",
        public_key="9md7cyq8h6xgvjs8",
        private_key="a0469645965a09ab1205776a34a1ddaf"
    )
)
...
def validate_user_session(id, token):
    ...
    try:
        ...
        return False #JsonResponse({'error': 'User does not exist'}, status=404)
